...
void drawTextureRhombus(double w, double h)
{
...
void drawTorus(double innerRadius, double outerRadius, int sides, int rings) {
    ModelerDrawState* mds = ModelerDrawState::Instance();
    ...
    for (int i = 0; i < rings; ++i) {
        double theta = i * ringDelta;
        double nextTheta = (i + 1) * ringDelta;

        glBegin(GL_QUAD_STRIP);
        for (int j = 0; j <= sides; ++j) {
            double phi = j * sideDelta;
            double cosPhi = cos(phi);
            double sinPhi = sin(phi);
            double dist = outerRadius + innerRadius * cosPhi;

            glNormal3d(cos(theta) * cosPhi, -sin(theta) * cosPhi, sinPhi);
            glVertex3d(cos(theta) * dist, -sin(theta) * dist, innerRadius * sinPhi);

            glNormal3d(cos(nextTheta) * cosPhi, -sin(nextTheta) * cosPhi, sinPhi);
            glVertex3d(cos(nextTheta) * dist, -sin(nextTheta) * dist, innerRadius * sinPhi);
        }
        glEnd();
    }
}
...
void drawTexCude3D(double width, double height, double depth) {
    ...
    glBegin(GL_QUADS);
    // Define vertices and texture coordinates for the back face
    glTexCoord2f(0.0f, 0.0f); glVertex3f(-width / 2, -height / 2, depth / 2);
    glTexCoord2f(1.0f, 0.0f); glVertex3f(width / 2, -height / 2, depth / 2);
    glTexCoord2f(1.0f, 1.0f); glVertex3f(width / 2, height / 2, depth / 2);
    glTexCoord2f(0.0f, 1.0f); glVertex3f(-width / 2, height / 2, depth / 2);
    ...
    glBegin(GL_QUADS);
    // Define vertices and texture coordinates for the top face
    glTexCoord2f(0.0f, 0.0f); glVertex3f(-width / 2, height / 2, -depth / 2);
    glTexCoord2f(1.0f, 0.0f); glVertex3f(width / 2, height / 2, -depth / 2);
    glTexCoord2f(1.0f, 1.0f); glVertex3f(width / 2, height / 2, depth / 2);
    glTexCoord2f(0.0f, 1.0f); glVertex3f(-width / 2, height / 2, depth / 2);
    ...
    glBegin(GL_QUADS);
    // Define vertices and texture coordinates for the bottom face
    glTexCoord2f(0.0f, 0.0f); glVertex3f(-width / 2, -height / 2, -depth / 2);
    glTexCoord2f(1.0f, 0.0f); glVertex3f(width / 2, -height / 2, -depth / 2);
    glTexCoord2f(1.0f, 1.0f); glVertex3f(width / 2, -height / 2, depth / 2);
    glTexCoord2f(0.0f, 1.0f); glVertex3f(-width / 2, -height / 2, depth / 2);
    ...
    glBegin(GL_QUADS);
    // Define vertices and texture coordinates for the left face
    glTexCoord2f(0.0f, 0.0f); glVertex3f(-width / 2, -height / 2, -depth / 2);
    glTexCoord2f(1.0f, 0.0f); glVertex3f(-width / 2, height / 2, -depth / 2);
    glTexCoord2f(1.0f, 1.0f); glVertex3f(-width / 2, height / 2, depth / 2);
    glTexCoord2f(0.0f, 1.0f); glVertex3f(-width / 2, -height / 2, depth / 2);
    ...
    glBegin(GL_QUADS);
    // Define vertices and texture coordinates for the right face
    glTexCoord2f(0.0f, 0.0f); glVertex3f(width / 2, -height / 2, -depth / 2);
    glTexCoord2f(1.0f, 0.0f); glVertex3f(width / 2, height / 2, -depth / 2);
    glTexCoord2f(1.0f, 1.0f); glVertex3f(width / 2, height / 2, depth / 2);
    glTexCoord2f(0.0f, 1.0f); glVertex3f(width / 2, -height / 2, depth / 2);
...
void drawRhombus(double width, double height) {
    ModelerDrawState* mds = ModelerDrawState::Instance();
    ...
    double vertices[6][3] = {
        ...
        {halfWidth, 0.0, halfHeight}, // Vertex 1
        {0, halfWidth, halfHeight}, // Vertex 2
        {-halfWidth, 0, halfHeight}, // Vertex 3
        {0, -halfWidth, halfHeight}, // Vertex 4
        {0, 0, height} // Vertex 5
    };
    // Draw the 8 faces of the rhombus using triangles
    ...
    drawTriangle(vertices[3][0], vertices[3][1], vertices[3][2],
    ...
    drawTriangle(vertices[5][0], vertices[5][1], vertices[5][2],
        vertices[1][0], vertices[1][1], vertices[1][2],
        vertices[2][0], vertices[2][1], vertices[2][2]);
    drawTriangle(vertices[5][0], vertices[5][1], vertices[5][2],
        vertices[2][0], vertices[2][1], vertices[2][2],
